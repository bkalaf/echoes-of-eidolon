...
- Target application release: `0.3.0`.
- Canonical note: `docs/release-notes/0_3_0.md`.
- Status: `DRAFT`.
- Release date: null. Draft releases are not public.
- Authoritative previous release: `0.2.1`. The repository still has no release tag.
