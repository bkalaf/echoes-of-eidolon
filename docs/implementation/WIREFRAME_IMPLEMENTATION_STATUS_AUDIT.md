...
| 157 | `DATA023` | Data - SpeciesGroup | `/admin/data/species-group` | **EXCLUDED** | Retired by WorldBuilding v3; no persistence, route, navigation, editor, or importer remains. |
...
| 200 | `DATA_SPECIESGROUP_EDIT` | Edit SpeciesGroup | `/admin/data/speciesgroup/sample-record` | **EXCLUDED** | Retired by WorldBuilding v3; the historical reviewed route is excluded from the active registry. |
...
| 234 | `DATA_SPECIESGROUP_IMPORT` | Bulk Import SpeciesGroup | `/admin/data/speciesgroup/import` | **EXCLUDED** | Retired by WorldBuilding v3; no SpeciesGroup import path remains. |
