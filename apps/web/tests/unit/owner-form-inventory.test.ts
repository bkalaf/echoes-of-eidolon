...
describe("owner form inventory artifacts", () => {
  it("independently verifies every generic entity form while separately inventorying bespoke editors", async () => {
  ...
  it("retains the mandatory browser scenarios and links the current shared Chromium evidence", async () => {
