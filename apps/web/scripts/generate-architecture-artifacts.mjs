...
const processDiagrams = [
  ...
  ["P19", "Atlas R08 release validation", ["Resolve controlled release root", "Verify manifest checksum", "Validate JSON schemas", "Check canonical counts", "Load EPSG 4326 records", "Reject SITE-0401 inference"], "AtlasReleaseManifest, Site, PointOfInterest", "Atlas admin"],
  ["P20", "Atlas two-dimensional layers", ["Layer choice", "Official or political asset", "EPSG 4326 projection", "Marker overlay", "Shared selection", "Detail panel"], "ManagedAsset, Site, PointOfInterest, Settlement", "Atlas 2D screens"],
  ...
  ["P22", "Shared Atlas selection", ["Select 2D marker", "Canonical record ID", "Selection store", "Project on globe", "Open detail", "Player disclosure filter"], "Site, PointOfInterest, Settlement", "Atlas 2D, Atlas 3D, Game map"],
...
const entityDiagrams = [
  ...
  ["E02", "Organization and access", ["Organization", "Member", "Invitation", "User"], "Organization, Member, Invitation, User", "Admin access"],
  ...
  ["E12", "Story identity", ["Character", "Protagonist", "Antagonist", "Witness", "Architect", "LegendaryReward", "PuzzleBlueprint"], "Story identity models", "Admin Campaign and Game"],
  ["E13", "Companion identity", ["Companion", "Protagonist", "Soul"], "Companion, Protagonist, Soul", "Admin Data and Game Companion"],
  ["E14", "Campaign placement", ["Campaign", "CampaignPlacement", "Pillar", "Lesson", "TimelineEvent", "Interlude", "Transition", "Companion"], "Campaign domain", "Admin Campaign"],
  ["E15", "Atlas geography", ["Site", "PointOfInterest", "Settlement"], "Site, PointOfInterest, Settlement", "Atlas Admin and Game maps"],
  ...
  ["E24", "Narrative reference catalog", ["Tome", "Lesson", "Definition", "Matrix", "Layette", "Constellation", "Ark"], "Canonical narrative reference models; no player-discovery link is invented", "Admin Data and Game reference surfaces"],
