...
const processDiagrams = [
  ...
  ["P36", "Canonical Architect Witness Guide population", ["Validate canonical manifest", "Resolve Breed dependencies", "Create Souls", "Create Architect Characters and subtypes", "Create Witness definitions", "Create Witness Characters with preserved Souls", "Create Witness subtypes", "Audit Guide identity mappings", "Verify idempotency"], "Soul, Character, Architect, WitnessDef, Witness", "Campaign Manager and Guide presentation"],
...
const entityDiagrams = [
  ...
  ["E26", "Guide identity and Witness continuity", ["Soul", "Character", "Architect", "WitnessDef", "Witness"], "Distinct Architect and Witness Characters sharing one Soul, with Guide forms resolving existing Characters", "Campaign Manager and Guide presentation"],
