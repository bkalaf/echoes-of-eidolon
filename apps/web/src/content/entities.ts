export const entityFields = {
  ...
  Architect: ["architectId", "characterId", "department"],
  ...
  Character: ["characterId", "displayName", "breedId", "occupationId", "worldKey", "soulId", "gender", "age", "faction", "primaryAttribute", "secondaryAttribute"],
  ...
  PersonalityExpression: ["personalityExpressionId", "name"],
  ...
  Species: ["speciesId", "name", "speciesKind", "scientificName", "taxonomy", "appearance", "anthropomorphization"],
  ...
  Witness: ["witnessId", "characterId", "witnessDefId", "trueFlawName", "architectId", "legendaryRewardId", "constellationBeforeId", "constellationAfterId"],
