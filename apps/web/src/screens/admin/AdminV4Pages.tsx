...
function plannerValue(companion: PlannerCompanion, world: typeof plannerWorlds[number], property: typeof plannerProperties[number], occupations: OccupationRecord[]) {
  ...
  if (property === "Age") return character.age === null ? "Not authored" : String(character.age);
  ...
  if (property === "Knowledge Skill") return companion.knowledgeSkill;
  if (property === "Awareness Skill") return companion.awarenessSkill;
